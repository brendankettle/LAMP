...
- Download something like GitHub desktop to manage the different experiment and LAMP repos, and to push/pull updates. If you don't know how to use git, I would recommend googling some tutorials.
